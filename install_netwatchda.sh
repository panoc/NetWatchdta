...
echo -e "  Help Menu      : ${CYAN}/etc/init.d/netwatchda help${NC}"
echo -e "  Edit Settings  : ${WHITE}${BOLD}$CONFIG_FILE${NC}"
echo -e "  Edit IP List   : ${WHITE}${BOLD}$IP_LIST_FILE${NC}"
echo -e "  Manage Keys    : ${WHITE}${BOLD}/etc/init.d/netwatchda credentials${NC}"
echo ""