...
* **🌍 Multi-Tier Monitoring:**
     * **Internet (WAN):** Checks external IPs (Cloudflare/Google).
...
Here is the file list formatted for your GitHub `README.md`. You can copy the code block below directly.
