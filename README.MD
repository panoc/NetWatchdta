...
| 50 Simultaneous Failures | OpenWrt (uclient) | OpenWrt (curl) | Linux (curl) |
| --- | --- | --- | --- |
| **RAM Spike** | **~30.0 MB** | **~125.0 MB** ⚠️ | **~250.0 MB** |
...
| 50 Simultaneous Failures | OpenWrt (uclient) | OpenWrt (curl) | Linux (curl) |
| --- | --- | --- | --- |
| **RAM Spike** | **~15.0 MB** 🟢 | **~17.0 MB** 🟢 | **~152.0 MB** |
| **Execution Time** | ~50s | ~50s | ~50s |
