...
```sh
wget --no-check-certificate -qO /tmp/install_netwatchdta.sh "https://raw.githubusercontent.com/panoc/NetWatchda/refs/heads/main/OpenWRT/install_netwatchdta_wrt.sh" && sh /tmp/install_netwatchdta.sh
